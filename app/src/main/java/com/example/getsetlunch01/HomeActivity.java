...
import com.example.getsetlunch01.Admin.AdminMaintainProductActivity;
import com.example.getsetlunch01.Model.Products;
import com.example.getsetlunch01.Prevalent.Prevalent;
import com.example.getsetlunch01.ViewHolder.ProductViewHolder;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
   ...
   private TextView user_ptofile_name,txtSearch;
  ...
  private RecyclerView recyclerView;
   ...
   public boolean onOptionsItemSelected(MenuItem item) {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        else if (id == R.id.nav_deliverd_orders)
        {
            if(!type.equals("Admin"))
            {
                Intent i= new Intent(HomeActivity.this,DeliverdOrdersActivity.class);
                startActivity(i);
            }
