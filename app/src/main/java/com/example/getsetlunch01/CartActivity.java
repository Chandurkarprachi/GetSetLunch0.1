...
import com.example.getsetlunch01.Model.Cart;
import com.example.getsetlunch01.Prevalent.Prevalent;
import com.example.getsetlunch01.ViewHolder.CartViewHolder;
                ...
                new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull CartViewHolder holder, int i, @NonNull final Cart model)
                    {
                       ...
                       // Pname=model.getPname().toString();
                        pname=holder.txtProductName.getText().toString();
                ...
                if(dataSnapshot.exists())
                {
                   ...
                   // String userName= dataSnapshot.child("name").getValue().toString();
                    ...
                    if(Shippmentstatus.equals("shipped"))
                    {
                        ...
                        txtMsg1.setText("Your final order has been shipped ,soon you will recive your order at your door step");
