...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    protected void onStart()
    {
        ...
        if(check.equals("settings"))
        {
            ...
            titlequestion.setText("Please Provide answers to following questions.");
    ...
    private void SetAnswers()
    {
        ...
        if(answer1.length()==0)
        {
            question1.setError("Provide Answer");
            question1.requestFocus();
        }
        else if(answer2.length()==0)
        {
            question2.setError("Provide Answer");
        ...
        else
        {
            ...
            ref.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task)
                {
                    ...
                    {
                        Toast.makeText(ResetPasswordActivity.this, "answerd sucessfully.", Toast.LENGTH_SHORT).show();
